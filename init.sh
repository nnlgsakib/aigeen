...
$BINARY add-genesis-account $KEY "500000000000000000000000000"uaigent --keyring-backend $KEYRING --home $DATA_DIR
...
# - address: ai1eyhg8f84swv6afkp0lace42tcss46lql05hhex
#   name: localkey
#   pubkey: '{"@type":"/ethermint.crypto.v1.ethsecp256k1.PubKey","key":"A+FkxDmj0uHaIBgszVbjBiHY284dtYWR23pmvu02tZL5"}'
#   type: local
...
# food weird insane rice shift suffer honey toy tonight nasty language tide twist cinnamon window tissue genuine where escape jungle inspire sister insect meadow